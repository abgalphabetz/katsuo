...
class MiscellaneousTests {
     ...
     */
    @Test
    fun `test eight queens`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test knight tour`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test von koch conjecture`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test arithmetic puzzle`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test k regular simple graphs`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test english number words`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test syntax checker`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test sudoku`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test nongrams`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test crossword puzzle`(): Unit = fail("IMPLEMENT ME!!!")
