...
class GraphTests {
     ...
     */
    @Test
    fun `test edge`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test path`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test cycle`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test s tree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test ms tree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test isomorphism`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test degree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test depth first`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test connected components`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test bipartite graphs`(): Unit = fail("IMPLEMENT ME!!!")
}