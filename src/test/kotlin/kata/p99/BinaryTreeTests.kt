...
class BinaryTreeTests {
     ...
     */
    @Test
    fun `test t`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test cbal tree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test symmetric tree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test construct`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test sym cbal trees`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test hbal tree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test min nodes`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test leaves`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test internals`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test complete binary tree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test layout tree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test layout tree again`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test layout tree once again`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test stringify tree`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test order trees`(): Unit = fail("IMPLEMENT ME!!!")
     ...
     */
    @Test
    fun `test dotstring of tree`(): Unit = fail("IMPLEMENT ME!!!")
